...
public class newLunch {

    public static void lunchDisplay() {
        Scanner scanner = new Scanner(System.in);

        // Display the list of lunch recipes
        System.out.println("Lunch Recipes:");
        List<String> lunchRecipes = newRecipe.cuisines.get("Lunch");
